...
import com.wjt.lease.web.admin.vo.attr.AttrValueVo;
...
public class RoomInfoServiceImpl extends ServiceImpl<RoomInfoMapper, RoomInfo> implements RoomInfoService {
     ...
     */
    @Override
    public Result saveOrUpdateRoom(RoomSubmitVo roomSubmitVo) {
     ...
     */
    @Override
    public Result<IPage<RoomItemVo>> pageItem(long current, long size, RoomQueryVo queryVo) {
    ...
    public Result<RoomDetailVo> getDetailById(Long id) {
        ...
        if (ObjUtil.isNull(roomInfo)) {
            return Result.fail(301, "房间不存在");
        }
        ...
        //3.查询graphInfoList
        List<GraphVo> graphVoList = graphInfoMapper.selectGraphVoList(id,ItemType.ROOM);
        ...
        return Result.ok(adminRoomDetailVo);
    }
    ...
    @Transactional
    @Override
    public Result removeRoomById(Long id) {
        //1.删除RoomInfo
        super.removeById(id);
    ...
    public Result<List<RoomInfo>> listBasicByApartmentId(Long id) {
        ...
        List<RoomInfo> roomInfoList = super.list(queryWrapper);
